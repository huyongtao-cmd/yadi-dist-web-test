...
const OrgCenterRouters = [
        ...
        routes: [
          {
            ...
            meta: { title: '整车零售', keepAlive: true },
          ...
          },
          {
            ...
            meta: { title: '整车零售单详情', hidden: true, keepAlive: true },
            component: React.lazy(
              () =>
                import(
          ...
          },
          {
            ...
            meta: { title: '整车零售单编辑', hidden: true, keepAlive: true },
            component: React.lazy(
              () =>
                import(
                  '@/project/support/salesCenter/retailOrder/RetailOrderCreate'
          ...
          {
            path: '/salesCenter/partsRetailorder/create',
            name: 'partsRetailOrderCreate',
            meta: { title: '配件零售', keepAlive: true },
            component: React.lazy(
              () =>
                import(
                  '@/project/support/salesCenter/retailOrder/Parts/RetailOrderCreate'
                )
            )
          },
          {
            path: '/salesCenter/partsRetailorder/detail/:type/:id',
            name: 'partsRetailorder',
            meta: { title: '配件零售单详情', hidden: true, keepAlive: true },
            component: React.lazy(
              () =>
                import(
                  '@/project/support/salesCenter/retailOrder/Parts/RetailOrderDetail'
                )
            )
          },
          {
            path: '/salesCenter/partsRetailorder/edit/:id',
            name: 'partsRetailOrderEdit',
            meta: { title: '配件零售单编辑', hidden: true, keepAlive: true },
            component: React.lazy(
              () =>
                import(
                  '@/project/support/salesCenter/retailOrder/Parts/RetailOrderCreate'
        ...
        routes: [
          {
            ...
            meta: { title: '批发开单', keepAlive: true },
            component: React.lazy(
              () =>
                import(
        ...
        routes: [
          {
            ...
            meta: { title: '销售退货', keepAlive: true },
            component: React.lazy(
              () =>
                import(
        ...
        routes: [
          {
            ...
            meta: { title: '销售查询', keepAlive: true },
            component: React.lazy(
              () =>
                import(
        ...
        routes: [
          {
            ...
            name: 'returnsearch',
            meta: { title: '退货查询', keepAlive: true },
            component: React.lazy(
              () =>
                import(
        ...
        routes: [
          {
            ...
            name: 'customerSearch',
            meta: { title: '零售顾客查询', keepAlive: true },
            component: React.lazy(
          ...
          },
          {
            ...
            name: 'customeView',
            meta: { title: '零售顾客详情', hidden: true, keepAlive: true },
            component: React.lazy(
        ...
        routes: [
          {
            ...
            meta: { title: '调拨查询', keepAlive: true },
            component: React.lazy(
              () =>
                import(
          ...
          },
          {
            ...
            meta: { title: '调拨详情', hidden: true, keepAlive: true },
            component: React.lazy(
              () =>
                import(
      ...
      },
      {
        ...
        routes: [
          ...
          // },
          {
            ...
            meta: { title: '其他出库', keepAlive: true },
            component: React.lazy(
              () =>
                import(
          ...
          },
          {
            ...
            meta: { title: '其他出库编辑', keepAlive: true, hidden: true },
            component: React.lazy(
              () =>
                import(
          ...
          },
          {
            ...
            name: 'inventoryOutVehicleView',
            meta: { title: '其他出库详情', hidden: true, keepAlive: true },
            component: React.lazy(
              () =>
                import(
      ...
      },
      {
        ...
        routes: [
          ...
          // },
          {
            ...
            meta: { title: '其他入库', keepAlive: true },
            component: React.lazy(
              () =>
                import(
          ...
          },
          {
            ...
            meta: { title: '其他入库编辑', keepAlive: true, hidden: true },
            component: React.lazy(
              () =>
                import(
          ...
          },
          {
            ...
            meta: { title: '其他入库详情', hidden: true, keepAlive: true },
            component: React.lazy(
              () =>
                import(
        ...
        routes: [
          {
            ...
            meta: { title: '车架号状态查询', keepAlive: true },
            component: React.lazy(
          ...
          },
          {
            ...
            meta: { title: '车架号历史记录', keepAlive: true },
            component: React.lazy(
...

      {
        ...
        routes: [
          ...
          },
          {
            ...
            meta: { title: '盘点创建', keepAlive: true },
            component: React.lazy(
              () =>
                import(
    ...
    routes: [
      {
        ...
        routes: [
          ...
          },
          {
            ...
            meta: { title: '采购开单', keepAlive: true },
            component: React.lazy(
          ...
          },
          {
            ...
            name: 'purcOrderView',
            meta: { title: '采购明细', hidden: true, keepAlive: true },
            component: React.lazy(
    ...
    routes: [
      {
        ...
        component: React.lazy(
          () => import('@/project/middleGround/purc/SaleReport')
        )
      },
    ]
  },
  {
    path: '/settlement',
    name: 'settlement',
    meta: { title: '结算', hidden: true },
    routes: [
      {
        path: '/settlement/statement',
        name: 'settlementStatement',
        meta: { title: '采购结算单', keepAlive: true },
        component: React.lazy(
          () => import('@/project/middleGround/settlement/Statement')
        )
      },
      {
        path: '/settlement/statement/view/:type',
        name: 'settlementSettlementView',
        meta: {
          title: '采购结算单审核明细查看',
          hidden: true,
          keepAlive: true
        ...
        component: React.lazy(
          () => import('@/project/middleGround/settlement/Statement/Edit')
        )
      },
      {
        path: '/settlement/receipt',
        name: 'settlementReceipt',
        meta: { title: '收款结算单', keepAlive: true, hidden: true },
        component: React.lazy(
          () => import('@/project/middleGround/settlement/Receipt')
        )
      },
      {
        path: '/saleSettlement/receipt/view/:id',
        name: 'saleSettlementReceiptView',
        meta: { title: '收款结算单审核查看', hidden: true, keepAlive: true },
        component: React.lazy(
          () => import('@/project/middleGround/settlement/Receipt/View')
        )
      },
      {
        path: '/settlement/sale',
        name: 'settlementSale',
        meta: { title: '销售结算单', keepAlive: true },
        component: React.lazy(
          () => import('@/project/middleGround/settlement/Sale')
        )
      },
      {
        path: '/saleSettlement/sale/view/:id',
        name: 'settlementSaleView',
        meta: { title: '销售结算单审核查看', hidden: true, keepAlive: true },
        component: React.lazy(
          () => import('@/project/middleGround/settlement/Sale/Edit')
        )
      },
    ]
  },
  {
    ...
    routes: [
      {
        path: '/mainData/dealer/list',
        name: 'dealer',
        meta: { title: '经销商', keepAlive: true },
        component: React.lazy(
          () => import('@/project/support/salesCenter/dealer')
        )
      },
      {
        path: '/mainData/dealer/detail/:type/:id',
        name: 'dealerDeail',
      ...
      },
      {
        ...
        routes: [
          {
            path: '/mainData/store/list',
            name: 'storeList',
            meta: { title: '门店', keepAlive: true },
            component: React.lazy(
              () => import('@/project/support/orgCenter/store/List')
            )
          },
          {
            path: '/mainData/store/detail/:type/:id',
            name: 'storeEdit',
      ...
      {
        path: '/mainData/servingStation/list',
        name: 'servingStation',
        meta: { title: '维修站', keepAlive: true },
        component: React.lazy(
          () => import('@/project/support/orgCenter/servingStation')
        )
      },
      {
        path: '/mainData/servingStation/detail/:type/:id',
      ...
      {
        path: '/mainData/bikeDoc',
        name: 'bikeDoc',
        meta: { title: '商品', keepAlive: true },
        component: React.lazy(() => import('@/project/mainData/bikeDoc'))
      },
      {
        path: '/mainData/itemCenter/brand',
        name: 'brand',
        meta: { title: '商品品牌', keepAlive: true },
        component: React.lazy(() => import('@/project/support/itemCenter/Brand'))
      },
      {
        path: '/factoryCenter/anExamination',
        name: 'anExamination',
        meta: { title: '自检' },
        routes: [
          {
            path: '/factoryCenter/anExamination/list',
            name: 'anExaminationList',
            meta: { title: '门店自检', keepAlive: true },
            component: React.lazy(
              () => import('@/project/support/factoryCenter/anExamination')
            )
          },
          {
            path: '/factoryCenter/anExamination/details/:type/:id',
            name: 'examinationEdit',
            meta: { title: '自检单详情', keepAlive: true, hidden: true },
            component: React.lazy(
              () => import('@/project/support/factoryCenter/anExamination/Edit')
            )
          },
        ]
      },
      {
        path: '/mainData/bikeDoc/detail/:type/:id',
        name: 'bikeDetail',
      ...
      {
        path: '/mainData/itemCenter/businessDirectory',
        name: 'support-itemCenter-businessDirectory',
        meta: { title: '商品经营目录' },
        routes: [
          {
            path: '/mainData/itemCenter/businessDirectory/index',
            name: 'support-itemCenter-businessDirectory-publish',
            meta: { title: '商品发布', keepAlive: true },
            component: React.lazy(
      ...
      {
        path: '/mainData/warehousesetting',
        name: 'warehouseSetting',
        meta: { title: '仓库管理' },
        routes: [
          {
            path: '/mainData/warehousesetting/index',
            name: 'warehouseSettingIndex',
            meta: { title: '仓库', keepAlive: true },
            component: React.lazy(
              () =>
                import(
          ...
          {
            path: '/mainData/warehousesetting/create',
            name: 'warehouseSettingCreate',
            meta: { title: '仓库新建', keepAlive: true, hidden: true },
            component: React.lazy(
              () =>
                import(
          ...
          {
            path: '/mainData/warehousesetting/edit/:id',
      ...
      {
        path: '/mainData/empData/empList/detail/:type/:id',
        name: 'empEdit',
      ...
      // },
      {
        ...
        routes: [
          ...
          },
          {
            ...
            name: 'orgEdit',
            meta: { title: '组织编辑', hidden: true, keepAlive: true },
            component: React.lazy(
      ...
      },
      {
        ...
        routes: [
          ...
          },
          {
            ...
            name: 'createOu',
            meta: { title: '公司新建', hidden: true, keepAlive: true },
            component: React.lazy(
          ...
          },
          {
            ...
            name: 'editOu',
            meta: { title: '公司编辑', hidden: true, keepAlive: true },
            component: React.lazy(
              () => import('@/project/support/orgCenter/ouData/Edit')
            )
          },

...
export default class SupportItemList extends React.Component<Props, State> {
  ...
  constructor(props) {
    super(props);
    // this.detailPageUrl = '/orgCenter/mainData/dealer/detail';   
    // 下方 更改菜单配置
    this.detailPageUrl = '/mainData/dealer/detail';
    this.state = {
      tableRef: null,
      userTableRef: null,
      searchparmas: '',
  ...
  getTableActionButtons = ({ unBindLoading }): Array<ActionButtonProps> => {
    let btns: Array<ActionButtonProps> = [
      ...
      },
      {
        ...
        authCode: 'dealerListUpdateStatus'
      },
      // {
      //   text: '导入',
      //   key: 'import',
